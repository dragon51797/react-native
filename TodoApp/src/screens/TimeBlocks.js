...
export class TimeBlocks extends Component {
    ...
    render() {
        return (
                <View style={styles.container}>
                  <CustomNavBar showBack title={strings.timeBlocks}
                    infoTitle={strings.timeBlocks} infoContent={strings.timeBlocksInfo}
                  ...
                  <View>
                  <TouchableHighlight onPress={() => this.gotoMainScreen()} >
